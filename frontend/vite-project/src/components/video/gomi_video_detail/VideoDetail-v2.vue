<template>
    <v-card>
      ...
      <v-container
        v-for="(detail_performer, index_performer) in VIDEO_DETAIL.video_performers"
        :key="index_performer"
        class="px-2 px-md-4"
      >
      <v-divider v-if="index_performer != 0" class="my-divider py-0 pb-2"></v-divider>


          <h2 class="text-h7 text-md-h5 mx-auto mb-4 ">
            <strong class="text-h6 text-md-h4">{{ detail_performer.name }}</strong>（ 女優 ）
          </h2>
        ...
        >
          ...
          >
                  <template
                  v-for="(VIDEO, index) in connection_performers[detail_performer.name_eng]"
                  :key="index"
                  >
                  <v-col
                    cols="7"
      ...
      <v-container
        v-for="(detail_tag, index_tag) in VIDEO_DETAIL.video_tags"
        :key="index_tag"
      ...
      <v-divider v-if="true" class="my-divider py-0 pb-2"></v-divider>
          ...
          <h2 class="text-h7 text-md-h5 mx-auto mb-4 ">
            <strong class="text-h6 text-md-h4">{{ detail_tag.name }}</strong>（ タグ ）
          </h2>
        ...
        >
          ...
          >
                  <template
                  v-for="(VIDEO, index) in connection_tags[detail_tag.name_eng]"
                  :key="index"
                  >
                  <v-col
                    cols="7"
