    ...
    <div class="d-none d-xs-block">
        <v-row>
          ...
          <!-- ■■■■■■■■■■■■■■ -->
                  ...
                  >
                    <v-col
                    :cols="boolean_detail ? boolean_detail_one ? 8 : 7 : 6"
    ...
    return 'error';  // デフォルト
                ...
                >
                    ...
                    <v-col cols="6">
                      <v-row no-gutters>
                        ...
                        >
                          <v-img
                            class="rounded-t aspect-ratio-block pa-5"
                            :src="image"
                            lazy-src="https://picsum.photos/id/11/100/60"
                            alt="Image"
                          />
        ...
        >
                  ...
                  <v-row no-gutters>
                      <v-col cols="12"
                      class="rounded elevation-1"
                      :class="false ? 'rounded elevation-0' : ''"
                      >
                      <v-row no-gutters v-if="media[index]==true && kind==='video'" class="rounded-t">
                        <v-col cols="12" class="my-auto aspect-ratio-block mx-auto rounded-t">
                            <video controls class="w-100 my-auto px-0 my-auto rounded-t" playsinline autoplay muted>
                      ...
                      >                      
                        <v-img
                          v-if="!media[index]"
                          class="rounded-t aspect-ratio-block mx-auto"
                          :class="false ? 'rounded-b elevation-1' : ''"
                          :src="imageSrc(ITEM)"
                          lazy-src="https://picsum.photos/id/11/100/60"
                          alt="Image"
                          :to="url(ITEM)"
                      ...
                      <v-row v-if='kind==="video"' no-gutters>
                        <v-col cols="6" class="pa-0 my-0 my-fit-contdts d-flex">
                            <v-row no-gutters>
                              <v-btn
                                class="my-fit-contents pa-0 ma-auto"
